...
//! Project version string for NHNCloudOCR.
FOUNDATION_EXPORT const unsigned char NHNCloudOCRVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <NHNCloudOCR/PublicHeader.h>
